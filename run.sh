...
hadoop jar target/mp_project-1.0-SNAPSHOT-with-dependencies.jar mpproject.ACAM config.json
hadoop jar target/mp_project-1.0-SNAPSHOT-with-dependencies.jar mpproject.Main config.json